export function createWelcomeEmailTemplate(name, clientURL) {
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
    ...
    <div style="background-color: #ffffff; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      <p style="font-size: 18px; color: #5B86E5;"><strong>Merhaba ${name},</strong></p>
      <p>Mesajlaşma platformumuza katıldığınız için çok heyecanlıyız! Messenger, nerede olurlarsa olsunlar, arkadaşlarınız, aileniz ve iş 
      arkadaşlarınızla gerçek zamanlı olarak bağlantı kurmanızı sağlar.</p>
      
      <div style="background-color: #f8f9fa; padding: 25px; border-radius: 10px; margin: 25px 0; border-left: 4px solid #36D1DC;">
        <p style="font-size: 16px; margin: 0 0 15px 0;"><strong>Sadece birkaç adımda başlayın:</strong></p>
        <ul style="padding-left: 20px; margin: 0;">
          <li style="margin-bottom: 10px;">Profil resminizi ayarlayın.</li>
          <li style="margin-bottom: 10px;">Kişilerinizi bulun ve ekleyin.</li>
          <li style="margin-bottom: 10px;">Bir konuşma başlatın</li>
          <li style="margin-bottom: 0;">Fotoğrafları, videoları ve daha fazlasını paylaşın.</li>
        </ul>
      </div>
